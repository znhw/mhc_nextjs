...
import getPostMetadata from "../../../../fetch/getPostMetadataF3";
import Script from "next/script";

//Retrieve content with slug 
const getLessonContent = (slug: string) => {

  const folder = 'public/lessons/math-form-3/'
        ...
        <div className={styles.App}>
          <Layout>
            <div className={styles.title}>
              <a className={styles.lessonTag} href="/mathematics/form-3">&larr;	Form 3: Mathematics</a>
